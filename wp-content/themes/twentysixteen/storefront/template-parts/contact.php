...
<div class="container normal_bloc  pb-5 my-5">
    <div class="row">
      <h1 class="d-block mr-auto my-5 ml-auto">Coordonnées</h1>
    </div>
    <div class="row">

      <div class="offset-md-1 col-md-5 col-12 offset-1 contact_ac_email">
        <div class=" py-3 row  mt-3" style="line-height: 34px;">
    ...
    <div class="row">
      <h1 class="d-block my-5 mr-auto ml-auto">Horaires</h1>
    </div>
    <div class="row contact_ac">
      <div class="col-md-5 offset-md-1 offset-1">
        <ul>
