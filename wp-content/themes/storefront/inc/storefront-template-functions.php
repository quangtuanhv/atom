...
if ( ! function_exists( 'storefront_post_content' ) ) {
	...
	function storefront_post_content() {
		...
		<div class="entry-content row">
			<div class="col-xs-12 col-md-10 col-lg-8 product text-left">
		<?php
		...
		?>
			...
			<div class="col-xs-12 col-md-2 col-lg-3 product-price">
				<div class="wrap-price-post">
					<p>Prix de la réparation</p>
					<h3 class="ng-binding"><?php the_field('price_') ?> </h3>
					<hr>
					<p class="mb-0">
						<span>
...
if ( ! function_exists( 'storefront_post_thumbnail' ) ) {
	...
	function storefront_post_thumbnail( $size = 'full' ) {
		if ( has_post_thumbnail() ) {
			the_post_thumbnail( $size, array('class' => 'mr-auto ml-auto d-block') );
		}
		?> 
		<span class="text-center d-block mt-3"><?php echo @get_the_category()[0]->name; ?></span>
		<?php
		the_title( '<h2 class="text-center entry-title d-none">', '</h2>' );
	}
}
